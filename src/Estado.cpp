...
char pasoFaseRecentrado[24] = "inactive";
char pasoDisparadorRecentrado[24] = "none";
uint8_t pasoIntentoRecentrado = 0;
float pasoReingresoXCm = NAN;
float pasoReingresoYCm = NAN;
float pasoErrorLateralInicialRecentradoCm = 0.0f;
float pasoMejoraRecentradoCm = 0.0f;
float pasoProporcionLateral = 0.0f;
float pasoUmbralLateralCm = 0.0f;
float pasoVentanaInicioCm = 0.0f;
float pasoVentanaProgresoCm = 0.0f;
uint16_t pasoVentanaIndice = 0;
float pasoGiroHaciaLineaDeg = 0.0f;
float pasoGiroRetornoDeg = 0.0f;
float pasoCosteReingresoAvance = 0.0f;
float pasoCosteReingresoReversa = 0.0f;
float pasoCosteReingresoElegido = 0.0f;
bool pasoAutoridadMpu = false;
